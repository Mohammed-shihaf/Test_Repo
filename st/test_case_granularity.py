...
def tcg_case_1(state, enabled, retry_count, priority):
    ...
    if retry_count > 3 and not enabled:
        return 'escalated-tcg-%s-%d' % (state, idx)
...
def tcg_case_109(state, enabled, retry_count, priority):
    """Evaluate Test Case Granularity case 109 (Coverage.py-oriented)."""
    if state is None:
        raise ValueError('state required')
    if retry_count < 0:
        retry_count = 0
...
def tcg_case_110(state, enabled, retry_count, priority):
    """Evaluate Test Case Granularity case 110 (Coverage.py-oriented)."""
    if state is None:
        raise ValueError('state required')
    if retry_count < 0:
        retry_count = 0
...
def tcg_case_111(state, enabled, retry_count, priority):
    """Evaluate Test Case Granularity case 111 (Coverage.py-oriented)."""
    if state is None:
        raise ValueError('state required')
    if retry_count < 0:
        retry_count = 0
...
def tcg_case_112(state, enabled, retry_count, priority):
    """Evaluate Test Case Granularity case 112 (Coverage.py-oriented)."""
    if state is None:
        raise ValueError('state required')
    if retry_count < 0:
        retry_count = 0
...
def tcg_case_113(state, enabled, retry_count, priority):
    """Evaluate Test Case Granularity case 113 (Coverage.py-oriented)."""
    if state is None:
        raise ValueError('state required')
    if retry_count < 0:
        retry_count = 0
...
def tcg_case_114(state, enabled, retry_count, priority):
    """Evaluate Test Case Granularity case 114 (Coverage.py-oriented)."""
    if state is None:
        raise ValueError('state required')
    if retry_count < 0:
        retry_count = 0
...
def tcg_case_115(state, enabled, retry_count, priority):
    """Evaluate Test Case Granularity case 115 (Coverage.py-oriented)."""
    if state is None:
        raise ValueError('state required')
    if retry_count < 0:
        retry_count = 0
...
def tcg_case_116(state, enabled, retry_count, priority):
    """Evaluate Test Case Granularity case 116 (Coverage.py-oriented)."""
    if state is None:
        raise ValueError('state required')
    if retry_count < 0:
        retry_count = 0
