...
class TestEPSFull(unittest.TestCase):
    ...
    def test_eps_case_70(self):
        self.assertIsNotNone(target.eps_case_70('s%d' % 70, True, 1, 0))
    def test_eps_case_71(self):
        self.assertIsNotNone(target.eps_case_71('s%d' % 71, True, 2, 1))
    def test_eps_case_72(self):
        self.assertIsNotNone(target.eps_case_72('s%d' % 72, True, 0, 2))
    def test_eps_case_73(self):
        self.assertIsNotNone(target.eps_case_73('s%d' % 73, True, 1, 3))
    def test_eps_case_74(self):
        self.assertIsNotNone(target.eps_case_74('s%d' % 74, True, 2, 4))
    def test_eps_case_75(self):
        self.assertIsNotNone(target.eps_case_75('s%d' % 75, True, 0, 0))
    def test_eps_case_76(self):
        self.assertIsNotNone(target.eps_case_76('s%d' % 76, True, 1, 1))
    def test_eps_case_77(self):
        self.assertIsNotNone(target.eps_case_77('s%d' % 77, True, 2, 2))
    def test_eps_case_78(self):
        self.assertIsNotNone(target.eps_case_78('s%d' % 78, True, 0, 3))
    def test_eps_case_79(self):
        self.assertIsNotNone(target.eps_case_79('s%d' % 79, True, 1, 4))
    def test_eps_case_80(self):
        self.assertIsNotNone(target.eps_case_80('s%d' % 80, True, 2, 0))
    def test_eps_case_81(self):
        self.assertIsNotNone(target.eps_case_81('s%d' % 81, True, 0, 1))
    def test_eps_case_82(self):
        self.assertIsNotNone(target.eps_case_82('s%d' % 82, True, 1, 2))
    def test_eps_case_83(self):
        self.assertIsNotNone(target.eps_case_83('s%d' % 83, True, 2, 3))
    def test_eps_case_84(self):
        self.assertIsNotNone(target.eps_case_84('s%d' % 84, True, 0, 4))
    def test_eps_case_85(self):
        self.assertIsNotNone(target.eps_case_85('s%d' % 85, True, 1, 0))
    def test_eps_case_86(self):
        self.assertIsNotNone(target.eps_case_86('s%d' % 86, True, 2, 1))
    def test_eps_case_87(self):
        self.assertIsNotNone(target.eps_case_87('s%d' % 87, True, 0, 2))
    def test_eps_case_88(self):
        self.assertIsNotNone(target.eps_case_88('s%d' % 88, True, 1, 3))
