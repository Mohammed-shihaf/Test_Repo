...
class TestEPIFull(unittest.TestCase):
    ...
    def test_epi_case_76(self):
        self.assertIsNotNone(target.epi_case_76('s%d' % 76, True, 1, 1))
    def test_epi_case_77(self):
        self.assertIsNotNone(target.epi_case_77('s%d' % 77, True, 2, 2))
    def test_epi_case_78(self):
        self.assertIsNotNone(target.epi_case_78('s%d' % 78, True, 0, 3))
    def test_epi_case_79(self):
        self.assertIsNotNone(target.epi_case_79('s%d' % 79, True, 1, 4))
