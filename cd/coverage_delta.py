...
"""Stub: Coverage Delta % — Coverage Delta (not the target metric for this branch)."""
TOOL_HINT = 'Coverage.py'
DOMAIN = 'Coverage Delta'

class CoverageDeltaAnalyzer(object):
...
def evaluate_coverage_delta_sample(inputs):
    """Lightweight domain helper for Coverage Delta %."""
    analyzer = CoverageDeltaAnalyzer('coverage_delta')
