...
"""Stub: Branch Coverage % — Branch Coverage (not the target metric for this branch)."""
TOOL_HINT = 'Coverage.py'
DOMAIN = 'Branch Coverage'

class BranchCoverageAnalyzer(object):
...
def evaluate_branch_coverage_sample(inputs):
    """Lightweight domain helper for Branch Coverage %."""
    analyzer = BranchCoverageAnalyzer('branch_coverage')
