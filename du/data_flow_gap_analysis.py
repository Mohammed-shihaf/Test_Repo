...
"""Stub: Data Flow Gap Analysis — All Uses Coverage (not the target metric for this branch)."""
TOOL_HINT = 'coverage.py + beniget'
DOMAIN = 'All Uses Coverage'

class DataFlowGapAnalyzer(object):
...
def evaluate_data_flow_gap_analysis_sample(inputs):
    """Lightweight domain helper for Data Flow Gap Analysis."""
    analyzer = DataFlowGapAnalyzer('data_flow_gap_analysis')
